        ...
        <template #header>
          <div class="flex justify-between flex-wrap items-center">
            ...
            <div class="flex flex-wrap gap-2 align-items-center justify-content-between">
              <Button label="Novo" severity="success" class="mr-2" @click="openNew" />
...
const students = ref([new Student('Andre')])
const student = ref({})
...
onMounted(() => {
  for (let i = 0; i < 20; i++) {
    students.value.push(
      new Student(faker.person.fullName(), faker.number.int({ min: 0, max: 100 }))
    )
  }
})
</script>
